...
public class Player{
   ...
   public void displayscorecard(){
    ...
    @return int total*/
	  ...
	  /*This method will simulate the turn of the computer (rolling dice, picking a category, etc).*/
	  public void computerTurn(){
		  ...
		  //get and validate computer's choice
		  int choice=1;
		  while(chosen[choice-1]==true){
          ...
          //if statements to update scorecard based on computer's choice
          if(choice>=1&&choice<=6)
          	getBasicValues(choice);
          else if(choice==7||choice==8)
            getSevenEight(choice);
